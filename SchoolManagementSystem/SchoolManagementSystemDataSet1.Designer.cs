...
namespace SchoolManagementSystem {
    ...
    public partial class SchoolManagementSystemDataSet1 : global::System.Data.DataSet {
        ...
        public partial class TestDataTable : global::System.Data.TypedTableBase<TestRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TestRow AddTestRow(int Id, string name, string password) {
...
namespace SchoolManagementSystem.SchoolManagementSystemDataSet1TableAdapters {
    ...
    public partial class TestTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Test] ([Id], [name], [password]) VALUES (@Id, @name, @password" +
                ");\r\nSELECT Id, name, password FROM Test WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Test] SET [Id] = @Id, [name] = @name, [password] = @password WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_password = 1 AND [password] IS NULL) OR ([password] = @Original_password)));
SELECT Id, name, password FROM Test WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, name, password FROM dbo.Test";
        ...
        public virtual int Fill(SchoolManagementSystemDataSet1.TestDataTable dataTable) {
        ...
        public virtual SchoolManagementSystemDataSet1.TestDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            SchoolManagementSystemDataSet1.TestDataTable dataTable = new SchoolManagementSystemDataSet1.TestDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(SchoolManagementSystemDataSet1.TestDataTable dataTable) {
